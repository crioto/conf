...
mymultimediatools = {
    { "nightingale", "/opt/nightingale/nightingale-bin" },
...
globalkeys = awful.util.table.join(
    ...
    awful.key({                 }, "Num_Lock", function()
        awful.util.spawn_with_shell("lswitch")
    end),
...
awful.util.spawn_with_shell("killall -9 xscreensaver")
awful.util.spawn_with_shell("killall -9 cbatticon")
awful.util.spawn_with_shell("xscreensaver -no-splash &")
awful.util.spawn_with_shell("cbatticon &")
awful.util.spawn_with_shell("setxkbmap -option caps:numlock")
awful.util.spawn_with_shell("/usr/bin/xscreensaver-layout &")
